...
const Footer: React.FC = () => {
  return (
    <footer 
      className="w-full overflow-x-hidden bg-[#353535] px-10 pb-10"
    >
      <div 
      ...
      >
        ...
        <div className="w-full flex flex-col gap-2.5">
          {/* Row 1: Logo, Company, Tools, Policies */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-3">
                {/* Facebook */}
                <a href="#" className="size-8 rounded-full border-2 border-white flex items-center justify-center hover:border-[#57BE8B] transition-colors">
            ...
            {/* Column 2: Company */}
            <div className="flex flex-col gap-4">
              <h3 className="text-white font-urbanist font-bold text-base">
                Company
              </h3>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-start gap-3 cursor-pointer">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 shrink-0">
                    <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="#C0C0C0" strokeWidth="2" fill="none"/>
                    <path d="M22 6L12 13L2 6" stroke="#C0C0C0" strokeWidth="2" fill="none"/>
                  </svg>
                  <a 
                    href="mailto:info@filemyepr.in" 
                    className="text-gray-300 font-urbanist text-sm"
                  >
                    info@filemyepr.in
                  </a>
                </div>
                ...
                <div className="flex items-start gap-3 cursor-pointer">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mt-0.5 shrink-0">
                    <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z" stroke="#C0C0C0" strokeWidth="2" fill="none"/>
                    <circle cx="12" cy="10" r="3" stroke="#C0C0C0" strokeWidth="2" fill="none"/>
                  </svg>
          ...
          {/* Row 2: Still have doubts?, Reach out to us, Contact us */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            {/* Empty column to align with Logo column */}
            <div></div>

            {/* Column 2: Still have doubts? */}
            <div className="flex flex-col gap-4">
              <h3 className="text-white font-urbanist font-bold text-base">
                Still have doubts?
              </h3>
        ...
        <div className="w-full border-t border-gray-600 mt-10 pt-5"></div>
